...
import tw.org.ctssf.app.android.Receiver.NetworkChangeReceiver;
...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        intentFilter.addAction("tw.org.ctssf.app.android.net.conn.CONNECTIVITY_CHANGE");
    ...
    protected void showNoNetWorkDialog(){
        new AlertDialog.Builder(this)
                ...
                .setIcon(tw.org.ctssf.app.android.R.mipmap.ic_launcher)
